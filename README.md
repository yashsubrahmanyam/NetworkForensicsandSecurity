...
In this query, we filter for firewall log entries where traffic is denied by the firewall, as this would block the DDoS attack at the firewall and aid a subsequent investigation in understanding the origins of the attack. However, in the absence of a firewall, this query may still prove to be useful in determining the origins and nature of a DDoS attack once it has already taken place. ![image](https://github.com/user-attachments/assets/b38c0c28-de2f-47a9-aa3f-42301d5dcf71)
